        ...
        <div class="max-w-[980px] space-y-6 pb-12">
            ...
            <section class="{{ $sectionClass }}">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="role" name="role" value="{{ old('role') }}" class="{{ $inputClass }}">
                    </div>

                    <div>
                        <label for="timeline" class="mb-3 block text-base font-bold text-[#191a1e]">Timeline</label>
                        <input type="text" id="timeline" name="timeline" value="{{ old('timeline') }}" class="{{ $inputClass }}">
                    </div>

                    <div>
                        <label for="industry" class="mb-3 block text-base font-bold text-[#191a1e]">Industry</label>
                        <input type="text" id="industry" name="industry" value="{{ old('industry') }}" class="{{ $inputClass }}">
                    </div>

                    <div>
                        <label for="year" class="mb-3 block text-base font-bold text-[#191a1e]">Year</label>
                        <input type="text" id="year" name="year" value="{{ old('year') }}" class="{{ $inputClass }}">
                    </div>
                </div>
            </section>
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <div>
                            ...
                            <input type="text" id="tag_1" name="tags[]" value="{{ old('tags.0') }}" placeholder="Tag 1" class="{{ $inputClass }}">
                        </div>

                        <div>
                            <label for="tag_2" class="sr-only">Tag 2</label>
                            <input type="text" id="tag_2" name="tags[]" value="{{ old('tags.1') }}" placeholder="Tag 2" class="{{ $inputClass }}">
                        </div>

                        <div>
                            <label for="tag_3" class="sr-only">Tag 3</label>
                            <input type="text" id="tag_3" name="tags[]" value="{{ old('tags.2') }}" placeholder="Tag 3" class="{{ $inputClass }}">
                        </div>
                    </div>
                </div>
            </section>
            ...
            >
                <div class="mb-7">
                    ...
                    <p class="mt-2 text-base font-bold text-[#8b9099]">
                        Images shown in the case study lightbox.
                    </p>
                </div>
                    ...
                    <template x-for="(item, index) in galleryItems" :key="index">
                        <div class="rounded-[18px] border border-[#dedfe4] bg-white p-4">
                            <div class="grid gap-4 md:grid-cols-2">
                                <div>
                                    <label :for="'gallery_' + index + '_image'" class="mb-3 block text-base font-bold text-[#191a1e]">Image</label>
                                    <input
                                        type="file"
                                        :id="'gallery_' + index + '_image'"
                                ...
                                <div>
                                    <label :for="'gallery_' + index + '_alt_text'" class="mb-3 block text-base font-bold text-[#191a1e]">Alt text</label>
                                    <input
                                        type="text"
                                        :id="'gallery_' + index + '_alt_text'"
